...
class Trills_MaterialController extends Controller
{
        ...
        public function store(Request $request)
    {
        ...
        $data = $request->only(['grading', 'title','image', 'description','category','discount_price' ,'price','quantity']);
    ...
    $data=($request->only(['price', 'title', 'description', 'image', 'discount_price','grading','quantity']));
