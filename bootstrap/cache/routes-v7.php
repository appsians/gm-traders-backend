...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    2 => 
    array (
      0 => '{^(?|/api/stores/([^/]++)(?|(*:30))|/storage/(.*)(*:51))/?$}sDu',
    ),
    3 => 
    array (
      30 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\StoreController@show',
        'controller' => 'App\\Http\\Controllers\\Api\\StoreController@show',
        'namespace' => NULL,
        'prefix' => 'api/stores',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\StoreController@store',
        'controller' => 'App\\Http\\Controllers\\Api\\StoreController@store',
        'namespace' => NULL,
        'prefix' => 'api/stores',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\StoreController@update',
        'controller' => 'App\\Http\\Controllers\\Api\\StoreController@update',
        'namespace' => NULL,
        'prefix' => 'api/stores',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\StoreController@destroy',
        'controller' => 'App\\Http\\Controllers\\Api\\StoreController@destroy',
        'namespace' => NULL,
        'prefix' => 'api/stores',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\UserController@adminDashboard',
        'controller' => 'App\\Http\\Controllers\\UserController@adminDashboard',
        'namespace' => NULL,
        'prefix' => 'api',
        'where' => 
        array (
