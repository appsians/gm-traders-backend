        ...
        <div>
            ...
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('all_banner') }}">Banners</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Add New</li>
                </ol>
            </nav>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="{{ route('all_banner') }}" class="btn btn-secondary btn-icon-text mb-2 mb-md-0">
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" id="js-add-form" enctype="multipart/form-data">
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('all_banner') }}" class="btn btn-secondary btn-lg px-4">
                                Cancel
                            </a>
