...
<div class="page-content">
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin mb-4">
        <div>
            <h4 class="mb-3 mb-md-0">Community Posts Management</h4>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-4">All Community Posts</h6>
                    ...
                    <div class="table-responsive">
                        <table id="communityTable" class="table table-hover">
                            <thead>
                                <tr>
...
$(document).ready(function() {
    var table = $('#communityTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "{{ route('community.posts.data') }}",
            type: "GET",
        },
        columns: [
            {
            ...
            { 
                ...
                render: function(data, type, row) {
                    return '<div class="action-buttons">' +
                           '<a href="/community/user/' + row.user_id + '/posts" class="btn btn-sm btn-info" title="View User Posts">' +
        ...
        language: {
            ...
            emptyTable: "No community posts found",
