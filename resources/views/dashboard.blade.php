                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">
                                    <a href="{{ route('all_Order') }}">All Orders</a>
                                </h6>
                                <div class="dropdown mb-2">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item d-flex align-items-center" href="{{ route('all_Order') }}"><i data-feather="eye" class="icon-sm me-2"></i> <span>View All</span></a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card stat-card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">
                                    <a href="{{ route('all_Order') }}">Pending Orders</a>
                                </h6>
                                <div class="dropdown mb-2">
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card stat-card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">
                                    <a href="{{ route('all_Order') }}">Complete Orders</a>
                                </h6>
                                <div class="dropdown mb-2">
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card stat-card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">
                                    <a href="{{ url('trills/all') }}">All Trellis Materials</a>
                                </h6>
                            </div>
                            <div class="row">
                                <div class="col-12">
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card stat-card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">
                                    <a href="{{ route('all_plant') }}">All Plants</a>
                                </h6>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <h3 class="mb-2">{{ $plants}}</h3>
                                    <div class="d-flex align-items-baseline">
                                        <p class="text-success">
                ...
                <div class="col-md-4 grid-margin stretch-card">
                    <div class="card stat-card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-baseline">
                                <h6 class="card-title mb-0">
                                    <a href="{{ route('all_fruits') }}">All Fruits</a>
                                </h6>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <h3 class="mb-2">{{ $fruit}}</h3>
                                    <div class="d-flex align-items-baseline">
                                        <p class="text-warning">
            ...
            <div class="card recent-orders-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('all_Order') }}" class="view-all-link">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        {{ $rawPlacedDate ? \Carbon\Carbon::parse($rawPlacedDate)->format('M d, Y') : '-' }}
                                    </td>
                                    <td>
                                        @php
                                            // Get raw attribute to bypass accessor
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <span class="badge badge-status {{ $statusClass }}">{{ ucfirst($order->status ?? 'pending') }}</span>
                                    </td>
                                    <td>
                                        <button class="btn btn-sm btn-info view-order-btn" data-id="{{ $order->id }}" title="View Details">
...
$(document).ready(function() {
    ...
    if($('#customersChart').length) {
        var options1 = {
            ...
            series: [{
                name: 'Orders',
                data: [{{ $totalOrders }}, {{ $totalOrders }}, {{ $totalOrders }}, {{ $totalOrders }}, {{ $totalOrders }}, {{ $totalOrders }}, {{ $totalOrders }}]
            }],
            stroke: {
                width: 2,
                curve: "smooth"
    ...
    if($('#ordersChart').length) {
        var options2 = {
            ...
            series: [{
                name: '',
                data: [{{ $pendingOrders }}, {{ $pendingOrders }}, {{ $pendingOrders }}, {{ $pendingOrders }}, {{ $pendingOrders }}, {{ $pendingOrders }}, {{ $pendingOrders }}]
            }]
        };
    ...
    if($('#growthChart').length) {
        var options3 = {
            ...
            series: [{
                name: '',
                data: [{{ $completedOrders }}, {{ $completedOrders }}, {{ $completedOrders }}, {{ $completedOrders }}, {{ $completedOrders }}, {{ $completedOrders }}, {{ $completedOrders }}]
            }],
            stroke: {
                width: 2,
                curve: "smooth"
    ...
    function loadOrdersChart(range = '7', startDate = null, endDate = null) {
        const url = new URL("{{ route('dashboard.orders.chart.data') }}", window.location.origin);
