                    ...
                    <div class="flex-grow-1 me-2">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								...
								@endphp
								<img class="wd-30 ht-30 rounded-circle" src="{{ $imageUrl }}" alt="Profile" onerror="this.src='https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->first_name ?? 'User') }}&background=6571ff&color=fff&size=128'">
							</a>
								...
								<div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
									<div class="mb-3">
										@php
											...
											$imageUrl = $userImage ? asset('storage/' . $userImage) : 'https://ui-avatars.com/api/?name=' . urlencode(auth()->user()->first_name ?? 'User') . '&background=6571ff&color=fff&size=128';
										@endphp
										<img class="wd-80 ht-80 rounded-circle" src="{{ $imageUrl }}" alt="Profile" onerror="this.src='https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->first_name ?? 'User') }}&background=6571ff&color=fff&size=128'">
									</div>
									<div class="text-center">
										<p class="tx-16 fw-bolder">{{ auth()->user()->first_name ?? 'User'  }}</p>
