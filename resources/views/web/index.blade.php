...
<head>
    ...
    <!-- Favicon -->
<link rel="icon" href="https://bgmtraders.in/favicon.ico" sizes="48x48">

<link rel="apple-touch-icon"  href="https://bgmtraders.in/favicon.png">
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="{{asset('web/images/slider/banner2.jpg') }}" alt="Image">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{asset('web/images/slider/banner.jpg')}}" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="title mx-5 px-5 animated slideInDown">
                            <div class="title-center">
                                <h5>Welcome</h5>
        ...
        <div class="container py-5">
                ...
                <div class="row g-0 align-items-center">
                    <div class="col-md-5">
                        <div class="service-img p-5 wow fadeInRight" data-wow-delay="0.2s">
                            <img class="img-fluid rounded-circle" src="{{asset('web/images/section/Frame 32.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">
                ...
                <div class="row g-0 align-items-center">
                    <div class="col-md-5 order-md-1 text-md-end">
                        <div class="service-img p-5 wow fadeInLeft" data-wow-delay="0.2s">
                            <img class="img-fluid rounded-circle" src="{{asset('web/images/section/3d twin.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">
            ...
            <div class="service-item service-item-left">
                <div class="row g-0 align-items-center">
                    <div class="col-md-5">
                        <div class="service-img p-5 wow fadeInRight" data-wow-delay="0.2s">
                            <img class="img-fluid rounded-circle" src="{{asset('web/images/section/Photo shot.png')}}" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="service-text px-5 px-md-0 py-md-5 wow fadeInRight" data-wow-delay="0.5s">
            ...
            <div class="service-item service-item-right">
                <div class="row g-0 align-items-center">
                    <div class="col-md-5 order-md-1 text-md-end">
                        <div class="service-img p-5 wow fadeInLeft" data-wow-delay="0.2s">
                            <img class="img-fluid rounded-circle" src="{{asset('web/images/section/care calender.png') }}" alt="">
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="service-text px-5 px-md-0 py-md-5 text-md-end wow fadeInLeft" data-wow-delay="0.5s">
        ...
        <div class="container py-5">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="team-body">
                            <img class="img-fluid" src="{{asset('web/images/Gallery/img1.avif') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="team-body">
                            <img class="img-fluid" src="{{ asset('web/images/Gallery/img2.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{asset('web/images/Gallery/img3.jpg') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{asset('web/images/Gallery/img4.jpg') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{asset('web/images/Gallery/img5.avif') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{asset('web/images/Gallery/img6.jpg') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{ asset('web/images/Gallery/img7.jpg') }}" alt="">
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="team-item">
                        <div class="team-body">
                            ...
                            <img class="img-fluid" src="{{asset('web/images/Gallery/img8.avif') }}" alt="">
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.3s">
                <div class="testimonial-item text-center"
                    data-dot="<img class='img-fluid' src='{{asset('web/img/testimonial-1.svg')}}' alt=''>">
                ...
                <div class="testimonial-item text-center"
                    data-dot="<img class='img-fluid' src='{{asset('web/img/testimonial-2.svg')}}' alt=''>">
                ...
                <div class="testimonial-item text-center"
                    data-dot="<img class='img-fluid' src='{{asset('web/img/testimonial-3.svg')}}' alt=''>">
            ...
            <div class="d-flex justify-content-center mb-4">
                ...
                <a class="btn btn-lg-square btn-outline-primary border-2 m-1"
                    href="https://www.youtube.com/@BismillahGmtraders"><i class="fab fa-youtube"></i></a>
                             ...
                             <a class="btn btn-lg-square btn-outline-primary border-2 m-1"
                    href="https://www.instagram.com/bgmtradersprivitelimited?igsh=MWx1bTV0djZtenhpcw%3D%3D&utm_source=qr"><i class="fab fa-instagram"></i></a>
                      <a class="btn btn-lg-square btn-outline-primary border-2 m-1"
                    href="https://x.com/bgmtraders?s=11"><i class="fab fa-twitter"></i></a>
