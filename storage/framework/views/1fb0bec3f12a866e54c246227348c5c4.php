...
$(document).ready(function() {
    var table = $('#gradingTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('grading.data')); ?>",
            type: "GET",
        },
        columns: [
            { data: 'id', name: 'id' },
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/appsians/gm-traders-backend/resources/views/Admin/grading/datatable.blade.php ENDPATH**/ ?>