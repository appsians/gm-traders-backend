...
<div class="page-content">
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin mb-4">
        <div>
            <h4 class="mb-3 mb-md-0">Completed Orders</h4>
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-4">Completed Orders</h6>
                    <div class="table-responsive">
                        <table id="completeOrdersTable" class="table table-hover">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Order ID</th>
...
$(document).ready(function() {
    var table = $('#completeOrdersTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: "<?php echo e(route('complete_orders.data')); ?>",
            type: "GET",
        },
        columns: [
            { data: 'id', name: 'id' },
        ...
        language: {
            ...
            zeroRecords: "No matching completed orders found"
        }
    });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/appsians/gm-traders-backend/resources/views/Admin/Orders/complete_orders.blade.php ENDPATH**/ ?>