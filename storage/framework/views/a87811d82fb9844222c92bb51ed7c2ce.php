                        ...
                        <div class="aside-content">
                            ...
                            <div class="aside-body">
                                <ul class="list-unstyled chat-list" id="chatUserList">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $chatUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li class="chat-item" 
                                            data-id="<?php echo e($user['id']); ?>"
                                            data-first_name="<?php echo e($user['first_name']); ?>"
                                            data-image="<?php echo e($user['profile_image']); ?>"
                                            data-search="<?php echo e(strtolower($user['first_name'])); ?>">
                                            <a href="javascript:;" class="d-flex align-items-center text-decoration-none">
                                                <div class="chat-item-avatar position-relative">
                                                    ...
                                                    ?>
                                                    <img src="<?php echo e($avatarUrl ?: $placeholderUrl); ?>" 
                                                         class="user-avatar" 
                                                ...
                                                <div class="flex-grow-1">
                                                    <div class="d-flex justify-content-between align-items-start mb-1">
                                                        <h6 class="mb-0 fw-bold"><?php echo e($user['first_name']); ?></h6>
                                                        <small class="text-muted"><?php echo e($user['last_message_time']); ?></small>
                                                    </div>
                                                    <p class="text-muted small mb-0 text-truncate" style="max-width: 200px;">
                                                        <?php echo e($user['last_message']); ?>
...
$(document).ready(function() {
    ...
    $('#viewAllOrders').on('click', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('chat.user.orders', ':id')); ?>".replace(':id', receiverId),
            type: 'GET',
    ...
    $('#viewConsultancy').on('click', function() {
        ...
        $.ajax({
            url: "<?php echo e(route('chat.user.consultancy', ':id')); ?>".replace(':id', receiverId),
            type: 'GET',
            success: function(response) {
                if (response.status && response.data.length > 0) {
                    let html = `
    ...
    $(document).on('click', '.confirm-order-action-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo e(route('confirm_order', ':orderId')); ?>".replace(':orderId', orderId),
                    type: 'POST',
                    data: {
                        _token: '<?php echo e(csrf_token()); ?>'
                    },
    ...
    $(document).on('click', '.set-delivery-date-action-btn', function() {
        ...
        Swal.fire({
            ...
            html: '<input type="date" id="deliveryDateInput" class="swal2-input" min="<?php echo e(date("Y-m-d")); ?>" value="' + (currentDate || '') + '">',
            showCancelButton: true,
    ...
    $(document).on('click', '.delete-order-action-btn', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "<?php echo e(url('/Order/delete')); ?>/" + orderId,
                    type: 'DELETE',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/appsians/gm-traders-backend/resources/views/Admin/chat/index.blade.php ENDPATH**/ ?>