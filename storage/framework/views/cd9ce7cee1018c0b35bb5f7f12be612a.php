...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo e(asset('web/images/logo/GMtraders.svg')); ?>" />
</head>
<body>
			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-8 ps-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    <a href="#" class="noble-ui-logo d-block mb-2">BGM<span>Traders</span></a>
                    <h5 class="text-muted fw-normal mb-4">Welcome back! Log in to your account.</h5>
                    <form class="forms-sample" action="<?php echo e(route('store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                      <div class="mb-3">
...
<?php /**PATH C:\Users\chsan\Downloads\public_html (1)\public_html\resources\views/auth/login.blade.php ENDPATH**/ ?>