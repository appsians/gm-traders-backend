    ...
    Plants
								...
								<div class="table-responsive pt-3">
									<table  id="dataTableExample" class="table">
										...
										<tbody>
                                              <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr>
										 ...
										 <!--<div class="progress-bar progress-bar-striped progress-bar-animated bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>-->
											<!--		</div>-->
                                                    ...
                                                    <?php echo e($plant->title); ?>

												</td>

<td><img src="<?php echo e(asset($plant->image)); ?>" alt="Image"
     width="50" height="50"
     style="object-fit: cover; border-radius: 50%;">
</td>
												<td><?php echo e($plant->age); ?></td>
													<td><?php echo e($plant->grading); ?></td>
												<td><?php echo e($plant->price); ?></td>
												<td><?php echo e($plant->discount_price); ?></td>
												  <td>
        <?php if($plant->qr_code): ?>

             <div class="qr-print-wrapper" id="qr-wrapper-<?php echo e($plant->id); ?>">
            <img src="<?php echo e(asset('/qrcodes/' . $plant->qr_code)); ?>" class="qr-img">
        </div>


        <?php else: ?>
            <button class="btn btn-sm btn-primary generate-qr-btn" data-id="<?php echo e($plant->id); ?>">
                Generate QR
            </button>
        <?php endif; ?>
    </td>
...
margin: auto; /* center in table cell */
      ...
      <td id="action-<?php echo e($plant->id); ?>">
<?php if($plant->qr_code): ?>
<button class="btn btn-sm btn-warning print-qr-btn" data-id="<?php echo e($plant->id); ?>">
Print QR
</button>
<?php endif; ?>

                                                 <button class="btn btn-sm btn-primary edit-btn" data-id="<?php echo e($plant->id); ?>">
                                                    <i class="fa fa-edit"></i> Edit
                                                      </button>

                                                  <button class="btn btn-sm btn-danger delete-btn" data-id="<?php echo e($plant->id); ?>">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <input type="text" class="form-control form-control-lg" name="grading" id="grading">
        ...
        <div class="mb-4">
          ...
          <input type="file" accept="image/*" class="form-control form-control-lg" value="<?php echo e($plant->image); ?>" name="image" id="image">
          <input type="text" class="form-control mt-2" value="<?php echo e($plant->image); ?>" readonly>
...
if (data.image) {
    ...
    $('#preview-old-image')
        .attr('src', "<?php echo e(asset('')); ?>" + imgPath)
        .show();
}
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/zbas2urw91oa/public_html/resources/views/Admin/plant/datatable.blade.php ENDPATH**/ ?>