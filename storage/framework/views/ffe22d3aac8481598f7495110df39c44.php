                      ...
                      <div class="col-6 col-md-12 col-xl-5">
                        ...
                        <div class="d-flex align-items-baseline">
                          <p class="text-success">
                            <span></span>
                            <i data-feather="" class="icon-sm mb-1"></i>
                          </p>
                        </div>
                      </div>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                    <h6 class="card-title mb-0">
    <a href="<?php echo e(route('pendingorder')); ?>">Pending Orders</a>
</h6>
                      <div class="dropdown mb-2">
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex justify-content-between align-items-baseline">
                <h6 class="card-title mb-0">
    <a href="<?php echo e(route('complete_order')); ?>">Complete Orders</a>
</h6>
...
//         // remove sidebar-folded if exists
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\chsan\Downloads\public_html (1)\public_html\resources\views/dashboard.blade.php ENDPATH**/ ?>